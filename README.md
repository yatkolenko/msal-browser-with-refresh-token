# This is an update to the msal-browser library, to make it possible to get an update token and work with it.
...
<script
  ...
  src="https://alcdn.msauth.net/browser/2.32.2/js/msal-browser.min.js"
></script>
```
