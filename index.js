...
(function (global, factory) {
  ...
  var ClientAuthError = /** @class */ (function (_super) {
     ...
     */
    ClientAuthError.createTokenNullOrEmptyError = function (
     ...
     */
    ClientAuthError.createEndpointDiscoveryIncompleteError = function (
      errDetail
    ) {
      return new ClientAuthError(
    ...
    ClientAuthError.createUnableToGetOpenidConfigError = function (errDetail) {
      return new ClientAuthError(
        ...
        ClientAuthErrorMessage.unableToGetOpenidConfigError.desc +
    ...
    ClientAuthError.createInvalidStateError = function (
      ...
      return new ClientAuthError(
        ...
        ClientAuthErrorMessage.invalidStateError.desc +
          " Invalid State: " +
          invalidState +
          ", Root Err: " +
          errorString
     ...
     */
    ClientAuthError.createMultipleMatchingAppMetadataInCacheError =
      function () {
        return new ClientAuthError(
  ...
  var CredentialEntity = /** @class */ (function () {
        ...
        try {
          ...
          CredentialEntity.credentialRegexMap.set(
            ...
            new RegExp(
              "(?<=" +
                separator +
                CredentialEntity.credentialDomainRegex +
                ")" +
                separator +
                credVal +
                separator
    ...
    CredentialEntity.getCredentialType = function (key) {
      ...
      for (var _i = 0, _b = Object.keys(CredentialType); _i < _b.length; _i++) {
        var credKey = _b[_i];
        if (
          (_a = this.credentialRegexMap.get(CredentialType[credKey])) ===
            null || _a === void 0
            ? void 0
            : _a.test(key.toLowerCase())
        ) {
     ...
     */
    CredentialEntity.generateCredentialCacheKey = function (
      homeAccountId,
      environment,
      credentialType,
      clientId,
     ...
     * @param environment
     */
    CredentialEntity.generateAccountIdForCacheKey = function (
      homeAccountId,
      environment
    ) {
     ...
     * @param familyId
     */
    CredentialEntity.generateCredentialIdForCacheKey = function (
      credentialType,
      clientId,
      realm,
      familyId
    ) {
      var clientOrFamilyId =
     ...
     */
    CredentialEntity.generateClaimsHashForCacheKey = function (
      requestedClaimsHash
    ) {
    ...
    CredentialEntity.credentialDomainRegex =
      "(https?:\\/\\/)?((([\\w-]+\\.)*([\\w-]{1,63})(\\.(\\w{2,63})))|(localhost))(\\:[0-9]{4,5})?";
  ...
  var ClientConfigurationError = /** @class */ (function (_super) {
     ...
     */
    ClientConfigurationError.createClaimsRequestParsingError = function (
     ...
     * @param urlString
     */
    ClientConfigurationError.createInsecureAuthorityUriError = function (
      urlString
    ) {
      return new ClientConfigurationError(
     ...
     * @param inputScopes
     */
    ClientConfigurationError.createClientIdSingleScopeError = function (
      inputScopes
    ) {
      return new ClientConfigurationError(
     ...
     */
    ClientConfigurationError.createInvalidCloudDiscoveryMetadataError =
      function () {
        return new ClientConfigurationError(
     ...
     */
    ClientConfigurationError.createInvalidAzureCloudInstanceError =
      function () {
        return new ClientConfigurationError(
     ...
     */
    ClientConfigurationError.createInvalidAuthenticationHeaderError = function (
      invalidHeaderName,
      details
    ) {
      return new ClientConfigurationError(
  ...
  var ScopeSet = /** @class */ (function () {
    function ScopeSet(inputScopes) {
      ...
      var scopeArr = inputScopes
        ? StringUtils.trimArrayEntries(__spreadArrays(inputScopes))
        : [];
      var filteredInput = scopeArr
  ...
  function buildClientInfoFromHomeAccountId(homeAccountId) {
    ...
    var clientInfoParts = homeAccountId.split(
      Separators.CLIENT_INFO_SEPARATOR,
      2
    );
    return {
  ...
  var AccountEntity = /** @class */ (function () {
    ...
    AccountEntity.createAccount = function (
      ...
      account.realm =
        ((_a =
          idToken === null || idToken === void 0 ? void 0 : idToken.claims) ===
          null || _a === void 0
          ? void 0
          : _a.tid) || Constants.EMPTY_STRING;
      if (idToken) {
        ...
        account.localAccountId =
          ((_b =
            idToken === null || idToken === void 0
              ? void 0
              : idToken.claims) === null || _b === void 0
            ? void 0
            : _b.oid) ||
          ((_c =
            idToken === null || idToken === void 0
              ? void 0
              : idToken.claims) === null || _c === void 0
            ? void 0
            : _c.sub) ||
          Constants.EMPTY_STRING;
        /*
        ...
        var preferredUsername =
          (_d =
            idToken === null || idToken === void 0
              ? void 0
              : idToken.claims) === null || _d === void 0
            ? void 0
            : _d.preferred_username;
        var email = (
          (_e =
            idToken === null || idToken === void 0
              ? void 0
              : idToken.claims) === null || _e === void 0
            ? void 0
            : _e.emails
        )
     ...
     * @param idToken
     */
    AccountEntity.createGenericAccount = function (
      homeAccountId,
      idToken,
      authority,
      cloudGraphHostName,
        ...
        account.name =
          ((_d =
            idToken === null || idToken === void 0
              ...
              : idToken.claims) === null || _d === void 0
            ? void 0
            : _d.name) || Constants.EMPTY_STRING;
     ...
     * @param authType
     */
    AccountEntity.generateHomeAccountId = function (
      serverClientInfo,
      authType,
      logger,
      cryptoObj,
     ...
     */
    AccountEntity.accountInfoIsEqual = function (
      accountA,
      accountB,
      compareClaims
    ) {
  ...
  var CacheManager = /** @class */ (function () {
    ...
    CacheManager.prototype.getAllAccounts = function () {
      ...
      var accountValues = Object.keys(currentAccounts).map(function (
        accountKey
      ) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              currentAccessTokens = Object.keys(
                currentTokenCache.accessTokens
              ).map(function (key) {
     ...
     * @param realm
     */
    CacheManager.prototype.getAccountsFilteredByInternal = function (
      homeAccountId,
      environment,
      realm,
      nativeAccountId
      ...
      allCacheKeys.forEach(function (cacheKey) {
        ...
        if (
          !!homeAccountId &&
          !_this.matchHomeAccountId(entity, homeAccountId)
        ) {
          return;
        }
        ...
        if (
          !!nativeAccountId &&
          !_this.matchNativeAccountId(entity, nativeAccountId)
        ) {
          return;
        }
     ...
     * @param tokenType
     */
    CacheManager.prototype.getCredentialsFilteredByInternal = function (
      homeAccountId,
      environment,
      credentialType,
      clientId,
      ...
      allCacheKeys.forEach(function (cacheKey) {
        ...
        if (
          !!userAssertionHash &&
          !_this.matchUserAssertionHash(entity, userAssertionHash)
        ) {
          return;
        }
        /*
        ...
        if (
          !!credentialType &&
          !_this.matchCredentialType(entity, credentialType)
        ) {
          return;
        }
     ...
     * @param clientId
     */
    CacheManager.prototype.getAppMetadataFilteredByInternal = function (
      environment,
      clientId
    ) {
      var _this = this;
    ...
    CacheManager.prototype.getAuthorityMetadataByAlias = function (host) {
      ...
      allCacheKeys.forEach(function (cacheKey) {
        ...
        if (
          !_this.isAuthorityMetadata(cacheKey) ||
          ...
          switch (_a.label) {
            ...
            case 1:
              return [
                2 /*return*/,
                _a.sent() &&
                  this.removeItem(accountKey, CacheSchemaType.ACCOUNT),
              ];
          }
        });
      });
          ...
          switch (_a.label) {
            case 0:
              ...
              allCacheKeys.forEach(function (cacheKey) {
                ...
                var cacheEntity = _this.getSpecificCredential(
                  cacheKey,
                  credType
                );
                if (
     ...
     * @param authScheme
     */
    CacheManager.prototype.readCacheRecord = function (
      account,
      clientId,
      request,
      environment
      ...
      var cachedRefreshToken = this.readRefreshTokenFromCache(
        clientId,
        account,
        false
      );
      var cachedAppMetadata = this.readAppMetadataFromCache(
        environment,
        clientId
      );
     ...
     */
    CacheManager.prototype.readAccountFromCacheWithNativeAccountId = function (
      nativeAccountId
    ) {
     ...
     * @param authScheme
     */
    CacheManager.prototype.readAccessTokenFromCache = function (
      clientId,
      account,
      request
    ) {
      ...
      var accessTokens = Object.keys(credentialCache.accessTokens).map(
        function (key) {
     ...
     * @param familyRT
     */
    CacheManager.prototype.readRefreshTokenFromCache = function (
      clientId,
      account,
      familyRT
    ) {
      ...
      var refreshTokens = Object.keys(credentialCache.refreshTokens).map(
        function (key) {
     ...
     */
    CacheManager.prototype.readAppMetadataFromCache = function (
      environment,
      clientId
    ) {
     ...
     * @param clientId
     */
    CacheManager.prototype.isAppMetadataFOCI = function (
      environment,
      clientId
    ) {
     ...
     * @param homeAccountId
     */
    CacheManager.prototype.matchHomeAccountId = function (
      entity,
      homeAccountId
    ) {
      return !!(
     ...
     * @param oboAssertion
     */
    CacheManager.prototype.matchUserAssertionHash = function (
      entity,
      userAssertionHash
    ) {
      return !!(
     ...
     * @param credentialType
     */
    CacheManager.prototype.matchCredentialType = function (
      entity,
      credentialType
    ) {
      return (
     ...
     */
    CacheManager.prototype.matchNativeAccountId = function (
      entity,
      nativeAccountId
    ) {
      return !!(
    ...
    CacheManager.prototype.matchTarget = function (entity, target) {
      var isNotAccessTokenCredential =
     ...
     */
    CacheManager.prototype.generateAuthorityMetadataCacheKey = function (
      authority
    ) {
      return (
        AUTHORITY_METADATA_CONSTANTS.CACHE_KEY +
        "-" +
        this.clientId +
        "-" +
        authority
  ...
  function buildClientConfiguration(_a) {
    ...
    var loggerOptions = __assign(
      __assign({}, DEFAULT_LOGGER_IMPLEMENTATION),
      userLoggerOption
    );
    return {
      authOptions: buildAuthOptions(userAuthOptions),
      systemOptions: __assign(
  ...
  var ThrottlingUtils = /** @class */ (function () {
    ...
    ThrottlingUtils.generateThrottlingStorageKey = function (thumbprint) {
      return (
        ThrottlingConstants.THROTTLING_PREFIX + "." + JSON.stringify(thumbprint)
      );
    };
    /**
    ...
    ThrottlingUtils.preProcess = function (cacheManager, thumbprint) {
      ...
      if (value) {
        ...
        throw new ServerError(
          ((_a = value.errorCodes) === null || _a === void 0
            ? void 0
            : _a.join(" ")) || Constants.EMPTY_STRING,
          value.errorMessage,
          value.subError
        );
      }
     ...
     * @param response
     */
    ThrottlingUtils.postProcess = function (
      cacheManager,
      thumbprint,
      response
    ) {
    ...
    ThrottlingUtils.removeThrottle = function (
      cacheManager,
      clientId,
      request,
  ...
  var NetworkManager = /** @class */ (function () {
     ...
     * @param options
     */
    NetworkManager.prototype.sendPostRequest = function (
      thumbprint,
      tokenEndpoint,
      options
    ) {
  ...
  var RequestValidator = /** @class */ (function () {
     ...
     */
    RequestValidator.validateCodeChallengeParams = function (
      codeChallenge,
      codeChallengeMethod
    ) {
      if (
     ...
     * @param codeChallengeMethod
     */
    RequestValidator.validateCodeChallengeMethod = function (
      codeChallengeMethod
    ) {
      if (
        [
    ...
    RequestValidator.sanitizeEQParams = function (eQParams, queryParams) {
      ...
      return Object.fromEntries(
        Object.entries(eQParams).filter(function (_a) {
          var value = _a[1];
          return value !== "";
        })
      );
  ...
  var RequestParameterBuilder = /** @class */ (function () {
     ...
     */
    RequestParameterBuilder.prototype.addResponseTypeForTokenAndIdToken =
      function () {
        this.parameters.set(
          AADServerParamKeys.RESPONSE_TYPE,
          encodeURIComponent(
     ...
     * @param responseMode
     */
    RequestParameterBuilder.prototype.addResponseMode = function (
      responseMode
    ) {
      this.parameters.set(
     ...
     * @param addOidcScopes
     */
    RequestParameterBuilder.prototype.addScopes = function (
      scopes,
      addOidcScopes
    ) {
      ...
      var requestScopes = addOidcScopes
        ? __spreadArrays(scopes || [], OIDC_DEFAULT_SCOPES)
        : scopes || [];
     ...
     * @param redirectUri
     */
    RequestParameterBuilder.prototype.addPostLogoutRedirectUri = function (
      redirectUri
    ) {
      RequestValidator.validateRedirectUri(redirectUri);
      this.parameters.set(
     ...
     * @param claims
     */
    RequestParameterBuilder.prototype.addClaims = function (
      claims,
      clientCapabilities
    ) {
      var mergedClaims = this.addClientCapabilitiesToClaims(
        claims,
        clientCapabilities
      );
     ...
     * @param appTelemetry
     */
    RequestParameterBuilder.prototype.addApplicationTelemetry = function (
      appTelemetry
    ) {
      if (
        appTelemetry === null || appTelemetry === void 0
          ? void 0
     ...
     * @param codeChallengeMethod
     */
    RequestParameterBuilder.prototype.addCodeChallengeParams = function (
      codeChallenge,
      codeChallengeMethod
    ) {
     ...
     * @param refreshToken
     */
    RequestParameterBuilder.prototype.addRefreshToken = function (
      refreshToken
    ) {
      this.parameters.set(
     ...
     * @param clientSecret
     */
    RequestParameterBuilder.prototype.addClientSecret = function (
      clientSecret
    ) {
      this.parameters.set(
     ...
     */
    RequestParameterBuilder.prototype.addClientAssertion = function (
      clientAssertion
    ) {
     ...
     */
    RequestParameterBuilder.prototype.addClientAssertionType = function (
      clientAssertionType
    ) {
     ...
     * @param clientAssertion
     */
    RequestParameterBuilder.prototype.addOboAssertion = function (
      oboAssertion
    ) {
      this.parameters.set(
    ...
    RequestParameterBuilder.prototype.addExtraQueryParameters = function (
      ...
      var _this = this;
      var sanitizedEQParams = RequestValidator.sanitizeEQParams(
        eQParams,
        this.parameters
      );
    ...
    RequestParameterBuilder.prototype.addClientCapabilitiesToClaims = function (
      claims,
      clientCapabilities
    ) {
      var mergedClaims;
     ...
     */
    RequestParameterBuilder.prototype.addServerTelemetry = function (
      ...
      if (!this.config.systemOptions.preventCorsPreflight && ccsCred) {
        switch (ccsCred.type) {
          case CcsCredentialType.HOME_ACCOUNT_ID:
            try {
              var clientInfo = buildClientInfoFromHomeAccountId(
                ccsCred.credential
              );
  ...
  var IdTokenEntity = /** @class */ (function (_super) {
     ...
     * @param authority
     */
    IdTokenEntity.createIdTokenEntity = function (
      homeAccountId,
      environment,
      idToken,
      clientId,
  ...
  var AccessTokenEntity = /** @class */ (function (_super) {
    ...
    AccessTokenEntity.createAccessTokenEntity = function (
       ...
       */
      if (
        ((_a = atEntity.tokenType) === null || _a === void 0
          ? void 0
          : _a.toLowerCase()) !==
        exports.AuthenticationScheme.BEARER.toLowerCase()
      ) {
        ...
        switch (atEntity.tokenType) {
          case exports.AuthenticationScheme.POP:
            ...
            var tokenClaims = AuthToken.extractTokenClaims(
              accessToken,
              cryptoUtils
            );
            if (
              !((_b =
                tokenClaims === null || tokenClaims === void 0
                  ? void 0
                  : tokenClaims.cnf) === null || _b === void 0
                ? void 0
                : _b.kid)
            ) {
  ...
  var RefreshTokenEntity = /** @class */ (function (_super) {
     ...
     * @param authority
     */
    RefreshTokenEntity.createRefreshTokenEntity = function (
      homeAccountId,
      environment,
      refreshToken,
      clientId,
  ...
  var InteractionRequiredAuthError = /** @class */ (function (_super) {
     ...
     * @param subError
     */
    InteractionRequiredAuthError.isInteractionRequiredError = function (
      errorCode,
      errorString,
      subError
    ) {
      var isInteractionRequiredErrorCode =
        !!errorCode &&
        InteractionRequiredServerErrorMessage.indexOf(errorCode) > -1;
      var isInteractionRequiredSubError =
        !!subError &&
  ...
  var UrlString = /** @class */ (function () {
    ...
    UrlString.getDeserializedHash = function (hash) {
      ...
      var deserializedHash = StringUtils.queryStringToObject(
    ...
    UrlString.getDeserializedQueryString = function (query) {
      ...
      var deserializedQueryString = StringUtils.queryStringToObject(
        StringUtils.isEmpty(parsedQueryString) ? query : parsedQueryString
      );
      // Check if deserialization didn't work
  ...
  (function (PerformanceEventStatus) {
    PerformanceEventStatus[(PerformanceEventStatus["NotStarted"] = 0)] =
      "NotStarted";
    PerformanceEventStatus[(PerformanceEventStatus["InProgress"] = 1)] =
      "InProgress";
    PerformanceEventStatus[(PerformanceEventStatus["Completed"] = 2)] =
      "Completed";
  ...
  var PopTokenGenerator = /** @class */ (function () {
    ...
    PopTokenGenerator.prototype.generateCnf = function (request) {
      ...
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
          switch (_d.label) {
            case 0:
              (_a = this.performanceClient) === null || _a === void 0
                ? void 0
                : _a.addQueueMeasurement(
                    exports.PerformanceEvents.PopTokenGenerateCnf,
                    request.correlationId
                  );
              (_b = this.performanceClient) === null || _b === void 0
                ? void 0
                : _b.setPreQueueTime(
                    exports.PerformanceEvents.PopTokenGenerateKid,
                    request.correlationId
                  );
              return [4 /*yield*/, this.generateKid(request)];
            case 1:
              reqCnf = _d.sent();
              reqCnfString = this.cryptoUtils.base64Encode(
     ...
     * @returns
     */
    PopTokenGenerator.prototype.signPopToken = function (
      accessToken,
      keyId,
      request
    ) {
     ...
     * @returns
     */
    PopTokenGenerator.prototype.signPayload = function (
      payload,
      keyId,
      request,
      claims
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              resourceUrlString = resourceRequestUri
                ? new UrlString(resourceRequestUri)
                : undefined;
              resourceUrlComponents =
                resourceUrlString === null || resourceUrlString === void 0
                  ? void 0
                  : resourceUrlString.getUrlComponents();
              return [
                4 /*yield*/,
                  ...
                  __assign(
                    {
                      ...
                      m:
                        ...
                        resourceRequestMethod === void 0
                          ? void 0
                          : resourceRequestMethod.toUpperCase(),
                      u:
                        resourceUrlComponents === null ||
                        resourceUrlComponents === void 0
                          ? void 0
                          : resourceUrlComponents.HostNameAndPort,
                      nonce: shrNonce || this.cryptoUtils.createNewGuid(),
                      p:
                        resourceUrlComponents === null ||
                        resourceUrlComponents === void 0
                          ? void 0
                          : resourceUrlComponents.AbsolutePath,
                      q: (
                        resourceUrlComponents === null ||
                        resourceUrlComponents === void 0
                          ? void 0
  ...
  var AppMetadataEntity = /** @class */ (function () {
     ...
     */
    AppMetadataEntity.generateAppMetadataCacheKey = function (
      environment,
      clientId
    ) {
     ...
     * @param familyId
     */
    AppMetadataEntity.createAppMetadataEntity = function (
      clientId,
      environment,
      familyId
    ) {
  ...
  var ResponseHandler = /** @class */ (function () {
     ...
     * @param cryptoObj
     */
    ResponseHandler.prototype.validateServerAuthorizationCodeResponse =
      function (serverResponseHash, cachedState, cryptoObj) {
     ...
     */
    ResponseHandler.prototype.validateTokenResponse = function (
      serverResponse
    ) {
      // Check for error
      if (
     ...
     * @param authority
     */
    ResponseHandler.prototype.handleServerTokenResponse = function (
      serverTokenResponse,
      authority,
      reqTimestamp,
      request,
          ...
          switch (_b.label) {
            case 0:
              (_a = this.performanceClient) === null || _a === void 0
                ? void 0
                : _a.addQueueMeasurement(
                    exports.PerformanceEvents.HandleServerTokenResponse,
     ...
     * @param authority
     */
    ResponseHandler.prototype.generateCacheRecord = function (
      serverTokenResponse,
      authority,
      reqTimestamp,
      request,
      ...
      if (!StringUtils.isEmpty(serverTokenResponse.access_token)) {
        ...
        var responseScopes = serverTokenResponse.scope
        ...
        var extendedTokenExpirationSeconds =
          tokenExpirationSeconds + extExpiresIn;
        var refreshOnSeconds =
     ...
     * @param authority
     */
    ResponseHandler.prototype.generateAccountEntity = function (
      serverTokenResponse,
      idToken,
      authority,
      authCodePayload
      ...
      var cloudGraphHostName = authCodePayload
        ? authCodePayload.cloud_graph_host_name
        : Constants.EMPTY_STRING;
      var msGraphhost = authCodePayload
     ...
     * @param stateString
     */
    ResponseHandler.generateAuthenticationResult = function (
      cryptoObj,
      authority,
      cacheRecord,
      fromTokenCache,
        ...
        return __generator(this, function (_e) {
          switch (_e.label) {
            case 0:
              ...
              refreshToken = Constants.EMPTY_STRING;
              responseScopes = [];
              expiresOn = null;
            ...
            case 4:
              ...
              uid =
                (idTokenObj === null || idTokenObj === void 0
                  ? void 0
              ...
              return [
                2 /*return*/,
                {
                  ...
                  familyId: familyId,
                  tokenType:
                    ((_a = cacheRecord.accessToken) === null || _a === void 0
                      ? void 0
                      : _a.tokenType) || Constants.EMPTY_STRING,
                  state: requestState
                    ? requestState.userRequestState
                    : Constants.EMPTY_STRING,
                  cloudGraphHostName:
                    ((_b = cacheRecord.account) === null || _b === void 0
                      ? void 0
                      : _b.cloudGraphHostName) || Constants.EMPTY_STRING,
                  msGraphHost:
                    ((_c = cacheRecord.account) === null || _c === void 0
                      ? void 0
                      : _c.msGraphHost) || Constants.EMPTY_STRING,
                  code: code,
  ...
  var AuthorizationCodeClient = /** @class */ (function (_super) {
          ...
          switch (_c.label) {
            case 0:
              (_a = this.performanceClient) === null || _a === void 0
                ? void 0
                : _a.addQueueMeasurement(
                    exports.PerformanceEvents.GetAuthCodeUrl,
                    request.correlationId
                  );
              (_b = this.performanceClient) === null || _b === void 0
                ? void 0
                : _b.setPreQueueTime(
                    exports.PerformanceEvents.AuthClientCreateQueryString,
                    request.correlationId
                  );
     ...
     * @param request
     */
    AuthorizationCodeClient.prototype.acquireToken = function (
      request,
      authCodePayload
    ) {
      var _a, _b, _c, _d, _e, _f;
          ...
          switch (_g.label) {
            case 0:
              ...
              (_a = this.performanceClient) === null || _a === void 0
                ? void 0
                : _a.addQueueMeasurement(
                    exports.PerformanceEvents.AuthClientAcquireToken,
                    request.correlationId
                  );
              atsMeasurement =
                (_b = this.performanceClient) === null || _b === void 0
              ...
              (_c = this.performanceClient) === null || _c === void 0
                ? void 0
                : _c.setPreQueueTime(
                    exports.PerformanceEvents.AuthClientExecuteTokenRequest,
                    request.correlationId
                  );
              return [
                4 /*yield*/,
            ...
            case 1:
              response = _g.sent();
              requestId =
                (_d = response.headers) === null || _d === void 0
                  ? void 0
                  : _d[HeaderNames.X_MS_REQUEST_ID];
              httpVerAuthority =
                (_e = response.headers) === null || _e === void 0
                  ? void 0
                  : _e[HeaderNames.X_MS_HTTP_VERSION];
              if (httpVerAuthority) {
              ...
              (_f = this.performanceClient) === null || _f === void 0
                ? void 0
                : _f.setPreQueueTime(
                    exports.PerformanceEvents.HandleServerTokenResponse,
                    request.correlationId
     ...
     * @param hashFragment
     */
    AuthorizationCodeClient.prototype.handleFragmentResponse = function (
      hashFragment,
      cachedState
    ) {
      // Handle responses.
     ...
     * @param request
     */
    AuthorizationCodeClient.prototype.executeTokenRequest = function (
      authority,
      request
    ) {
      var _a, _b;
          ...
          switch (_c.label) {
            case 0:
              ...
              (_b = this.performanceClient) === null || _b === void 0
                ? void 0
                : _b.setPreQueueTime(
                    exports.PerformanceEvents.AuthClientCreateTokenRequestBody,
                    request.correlationId
                  );
              queryParametersString = this.createTokenQueryParameters(request);
              endpoint = UrlString.appendQueryString(
            ...
            case 1:
              ...
              return [
                2 /*return*/,
                this.executePostToTokenEndpoint(
                  endpoint,
                  requestBody,
                  headers,
                  thumbprint
     ...
     * @param request
     */
    AuthorizationCodeClient.prototype.createTokenRequestBody = function (
      request
    ) {
      var _a, _b;
      return __awaiter(this, void 0, void 0, function () {
            ...
            case 3:
              ...
              if (this.config.systemOptions.preventCorsPreflight && ccsCred) {
                switch (ccsCred.type) {
                  case CcsCredentialType.HOME_ACCOUNT_ID:
                    try {
                      clientInfo = buildClientInfoFromHomeAccountId(
                        ccsCred.credential
                      );
     ...
     * @param request
     */
    AuthorizationCodeClient.prototype.createAuthCodeUrlQueryString = function (
      request
    ) {
      var _a;
      return __awaiter(this, void 0, void 0, function () {
            ...
            case 0:
              ...
              if (request.prompt !== PromptValue.SELECT_ACCOUNT) {
                ...
                if (request.sid && request.prompt === PromptValue.NONE) {
                  ...
                  accountLoginHintClaim = this.extractLoginHint(
                    request.account
                  );
     ...
     * @param request
     */
    AuthorizationCodeClient.prototype.createLogoutUrlQueryString = function (
      request
    ) {
      var parameterBuilder = new RequestParameterBuilder();
    ...
    AuthorizationCodeClient.prototype.extractAccountSid = function (account) {
      var _a;
      return (
        ((_a = account.idTokenClaims) === null || _a === void 0
          ? void 0
          : _a.sid) || null
      );
    };
  ...
  var RefreshTokenClient = /** @class */ (function (_super) {
          ...
          switch (_h.label) {
            case 0:
              (_a = this.performanceClient) === null || _a === void 0
                ? void 0
                : _a.addQueueMeasurement(
                    exports.PerformanceEvents.RefreshTokenClientAcquireToken,
                    request.correlationId
                  );
              atsMeasurement =
                (_b = this.performanceClient) === null || _b === void 0
            ...
            case 1:
              ...
              httpVerToken =
                (_d = response.headers) === null || _d === void 0
                  ? void 0
                  : _d[HeaderNames.X_MS_HTTP_VERSION];
              atsMeasurement === null || atsMeasurement === void 0
                ? void 0
                : atsMeasurement.addStaticFields({
                    refreshTokenSize:
                      ((_e = response.body.refresh_token) === null ||
                      _e === void 0
                        ? void 0
                        : _e.length) || 0,
                  });
              ...
              requestId =
                (_f = response.headers) === null || _f === void 0
                  ? void 0
                  : _f[HeaderNames.X_MS_REQUEST_ID];
              responseHandler = new ResponseHandler(
                this.config.authOptions.clientId,
                this.cacheManager,
                this.cryptoUtils,
              ...
              responseHandler.validateTokenResponse(response.body);
              (_g = this.performanceClient) === null || _g === void 0
                ? void 0
                : _g.setPreQueueTime(
                    exports.PerformanceEvents.HandleServerTokenResponse,
                    request.correlationId
     ...
     * @param request
     */
    RefreshTokenClient.prototype.acquireTokenByRefreshToken = function (
      request
    ) {
      var _a, _b, _c, _d;
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
          ...
          isFOCI = this.cacheManager.isAppMetadataFOCI(
          ...
          (_d = this.performanceClient) === null || _d === void 0
            ? void 0
            : _d.setPreQueueTime(
                exports.PerformanceEvents
                  .RefreshTokenClientAcquireTokenWithCachedRefreshToken,
     ...
     * @param request
     */
    RefreshTokenClient.prototype.acquireTokenWithCachedRefreshToken = function (
      request,
      foci
    ) {
      var _a, _b, _c;
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
          ...
          refreshToken = this.cacheManager.readRefreshTokenFromCache(
            this.config.authOptions.clientId,
            request.account,
            foci
          );
     ...
     * @param authority
     */
    RefreshTokenClient.prototype.executeTokenRequest = function (
      request,
      authority
    ) {
      var _a, _b, _c;
            ...
            case 1:
              ...
              return [
                ...
                this.executePostToTokenEndpoint(
                  ...
                  .then(function (result) {
                    acquireTokenMeasurement === null ||
                    acquireTokenMeasurement === void 0
                      ? void 0
  ...
  var SilentFlowClient = /** @class */ (function (_super) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              e_1 = _a.sent();
              if (
                e_1 instanceof ClientAuthError &&
                e_1.errorCode ===
                  ClientAuthErrorMessage.tokenRefreshRequired.code
              ) {
          ...
          switch (_e.label) {
            case 0:
              ...
              if (request.forceRefresh) {
                ...
                (_a = this.serverTelemetryManager) === null || _a === void 0
                  ? void 0
                  : _a.setCacheOutcome(CacheOutcome.FORCE_REFRESH);
                this.logger.info(
              ...
              cacheRecord = this.cacheManager.readCacheRecord(
                request.account,
                this.config.authOptions.clientId,
                request,
                environment
              ...
              if (!cacheRecord.accessToken) {
                ...
                (_b = this.serverTelemetryManager) === null || _b === void 0
                  ? void 0
                  : _b.setCacheOutcome(CacheOutcome.NO_CACHED_ACCESS_TOKEN);
                this.logger.info(
                ...
                TimeUtils.wasClockTurnedBack(
                  cacheRecord.accessToken.cachedAt
                ) ||
                ...
                (_c = this.serverTelemetryManager) === null || _c === void 0
                  ? void 0
                  : _c.setCacheOutcome(
                ...
                (_d = this.serverTelemetryManager) === null || _d === void 0
                  ? void 0
                  : _d.setCacheOutcome(
     ...
     * @param cacheRecord
     */
    SilentFlowClient.prototype.generateResultFromCacheRecord = function (
      cacheRecord,
      request
    ) {
      return __awaiter(this, void 0, void 0, function () {
  ...
  var AuthorityMetadataEntity = /** @class */ (function () {
     ...
     * @param fromNetwork
     */
    AuthorityMetadataEntity.prototype.updateCloudDiscoveryMetadata = function (
      metadata,
      fromNetwork
    ) {
     ...
     * @param fromNetwork
     */
    AuthorityMetadataEntity.prototype.updateEndpointMetadata = function (
      metadata,
      fromNetwork
    ) {
     ...
     * @param authority
     */
    AuthorityMetadataEntity.prototype.updateCanonicalAuthority = function (
      authority
    ) {
  ...
  var RegionDiscovery = /** @class */ (function () {
     ...
     */
    RegionDiscovery.prototype.detectRegion = function (
      environmentRegion,
          ...
          switch (_e.label) {
            case 0:
              (_a = this.performanceClient) === null || _a === void 0
                ? void 0
                : _a.addQueueMeasurement(
                    exports.PerformanceEvents.RegionDiscoveryDetectRegion,
                    this.correlationId
                  );
            ...
            case 1:
              ...
              (_b = this.performanceClient) === null || _b === void 0
                ? void 0
                : _b.setPreQueueTime(
                    exports.PerformanceEvents.RegionDiscoveryGetRegionFromIMDS,
                    this.correlationId
                  );
              return [
                4 /*yield*/,
            ...
            case 2:
              ...
              if (
                localIMDSVersionResponse.status === ResponseCodes.httpSuccess
              ) {
              ...
              (_c = this.performanceClient) === null || _c === void 0
                ? void 0
                : _c.setPreQueueTime(
                    exports.PerformanceEvents.RegionDiscoveryGetCurrentVersion,
                    this.correlationId
                  );
            ...
            case 4:
              ...
              if (
                currentIMDSVersionResponse.status === ResponseCodes.httpSuccess
              ) {
  ...
  var Authority = /** @class */ (function () {
    ...
    Authority.prototype.replacePath = function (urlString) {
      ...
      var cachedAuthorityParts =
        cachedAuthorityUrl.getUrlComponents().PathSegments;
      var currentAuthorityParts =
          ...
          switch (_d.label) {
            case 0:
              (_a = this.performanceClient) === null || _a === void 0
                ? void 0
                : _a.addQueueMeasurement(
                    exports.PerformanceEvents.AuthorityResolveEndpointsAsync,
                    this.correlationId
                  );
              metadataEntity = this.cacheManager.getAuthorityMetadataByAlias(
                this.hostnameAndPort
              );
              if (!metadataEntity) {
                metadataEntity = new AuthorityMetadataEntity();
                metadataEntity.updateCanonicalAuthority(
            ...
            case 1:
              ...
              (_c = this.performanceClient) === null || _c === void 0
                ? void 0
                : _c.setPreQueueTime(
                    exports.PerformanceEvents.AuthorityUpdateEndpointMetadata,
                    this.correlationId
                  );
            ...
            case 2:
              ...
              cacheKey = this.cacheManager.generateAuthorityMetadataCacheKey(
        ...
        return __generator(this, function (_g) {
          switch (_g.label) {
            ...
            case 1:
              ...
              if (
                !((_c = this.authorityOptions.azureRegionConfiguration) ===
                  null || _c === void 0
                  ? void 0
                  : _c.azureRegion)
              )
            ...
            case 4:
              if (
                ...
                return [3 /*break*/, 7];
              if (
                !((_e = this.authorityOptions.azureRegionConfiguration) ===
                  null || _e === void 0
                  ? void 0
                  : _e.azureRegion)
              )
     ...
     */
    Authority.prototype.updateMetadataWithRegionalInformation = function (
      metadata
    ) {
      var _a, _b, _c, _d, _e, _f, _g;
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_h) {
          switch (_h.label) {
            ...
            case 1:
              ...
              azureRegion =
                ((_d = this.authorityOptions.azureRegionConfiguration) ===
                  null || _d === void 0
                  ? void 0
                  : _d.azureRegion) ===
                Constants.AZURE_REGION_AUTO_DISCOVER_FLAG
                  ...
                  : _e.azureRegion;
              if (
                ((_f = this.authorityOptions.azureRegionConfiguration) ===
                  null || _f === void 0
                  ? void 0
                  : _f.azureRegion) ===
                Constants.AZURE_REGION_AUTO_DISCOVER_FLAG
                ...
                if (autodetectedRegionName) {
                  this.regionDiscoveryMetadata.region_outcome =
                    ((_g = this.authorityOptions.azureRegionConfiguration) ===
                      null || _g === void 0
                      ? void 0
                      : _g.azureRegion) === autodetectedRegionName
     ...
     * @param newMetadata
     */
    Authority.prototype.updateCloudDiscoveryMetadata = function (
      metadataEntity
    ) {
      var _a, _b;
      return __awaiter(this, void 0, void 0, function () {
    ...
    Authority.prototype.getCloudDiscoveryMetadataFromConfig = function () {
      ...
      if (this.authorityOptions.cloudDiscoveryMetadata) {
        ...
        try {
          ...
          var metadata = Authority.getCloudDiscoveryMetadataFromNetworkResponse(
     ...
     */
    Authority.prototype.getCloudDiscoveryMetadataFromHarcodedValues =
      function () {
    ...
    Authority.prototype.isInKnownAuthorities = function () {
      var _this = this;
      var matches = this.authorityOptions.knownAuthorities.filter(function (
        authority
      ) {
        return (
          UrlString.getDomainFromUrl(authority).toLowerCase() ===
          _this.hostnameAndPort
        );
      });
     ...
     */
    Authority.generateAuthority = function (
      authorityString,
      azureCloudOptions
    ) {
      ...
      if (
        ...
        var tenant = azureCloudOptions.tenant
          ? azureCloudOptions.tenant
          : Constants.DEFAULT_COMMON_TENANT;
        authorityAzureCloudInstance =
          azureCloudOptions.azureCloudInstance + "/" + tenant + "/";
      }
     ...
     * @param authority
     */
    Authority.getCloudDiscoveryMetadataFromNetworkResponse = function (
      response,
      authority
    ) {
     ...
     * @param region string
     */
    Authority.buildRegionalAuthorityString = function (
      host,
      region,
      queryString
    ) {
      ...
      if (this.isPublicCloudAuthority(authorityUrlParts.HostNameAndPort)) {
        hostNameAndPort =
          region + "." + Constants.REGIONAL_AUTH_PUBLIC_CLOUD_SUFFIX;
      }
     ...
     */
    Authority.replaceWithRegionalInformation = function (
      metadata,
      azureRegion
    ) {
      metadata.authorization_endpoint = Authority.buildRegionalAuthorityString(
      ...
      if (metadata.end_session_endpoint) {
        metadata.end_session_endpoint = Authority.buildRegionalAuthorityString(
  ...
  var AuthorityFactory = /** @class */ (function () {
     ...
     * @param protocolMode
     */
    AuthorityFactory.createDiscoveredInstance = function (
      authorityUri,
      networkClient,
      cacheManager,
      authorityOptions,
      ...
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              performanceClient === null || performanceClient === void 0
                ? void 0
              ...
              acquireTokenAuthority = AuthorityFactory.createInstance(
                authorityUri,
                networkClient,
                cacheManager,
                authorityOptions,
  ...
  var AuthenticationHeaderParser = /** @class */ (function () {
    ...
    AuthenticationHeaderParser.prototype.getShrNonce = function () {
      ...
      if (authenticationInfo) {
        var authenticationInfoChallenges =
  ...
  var ServerTelemetryManager = /** @class */ (function () {
     ...
     */
    ServerTelemetryManager.prototype.generateCurrentRequestHeaderValue =
      function () {
        var request =
          "" +
          this.apiId +
          ...
          this.cacheOutcome;
        var platformFields = [this.wrapperSKU, this.wrapperVer].join(
          SERVER_TELEM_CONSTANTS.VALUE_SEPARATOR
        );
     ...
     */
    ServerTelemetryManager.prototype.generateLastRequestHeaderValue =
      function () {
        var lastRequests = this.getLastRequests();
        var maxErrors = ServerTelemetryManager.maxErrorsToSend(lastRequests);
        var failedRequests = lastRequests.failedRequests
          .slice(0, 2 * maxErrors)
          .join(SERVER_TELEM_CONSTANTS.VALUE_SEPARATOR);
        var errors = lastRequests.errors
          .slice(0, maxErrors)
          .join(SERVER_TELEM_CONSTANTS.VALUE_SEPARATOR);
        ...
        var platformFields = [errorCount, overflow].join(
          SERVER_TELEM_CONSTANTS.VALUE_SEPARATOR
        );
        return [
          SERVER_TELEM_CONSTANTS.SCHEMA_VERSION,
    ...
    ServerTelemetryManager.prototype.getLastRequests = function () {
      ...
      var lastRequests = this.cacheManager.getServerTelemetry(
        this.telemetryCacheKey
      );
    ...
    ServerTelemetryManager.prototype.clearTelemetryCache = function () {
      ...
      if (numErrorsFlushed === errorCount) {
        ...
        serverTelemEntity.failedRequests = lastRequests.failedRequests.slice(
          numErrorsFlushed * 2
     ...
     * @returns void
     */
    ServerTelemetryManager.prototype.updateRegionDiscoveryMetadata = function (
      regionDiscoveryMetadata
    ) {
  ...
  var PerformanceClient = /** @class */ (function () {
     ...
     */
    /* eslint-disable-next-line @typescript-eslint/no-unused-vars */
    PerformanceClient.prototype.startPerformanceMeasurement = function (
      measureName,
      correlationId
    ) {
      return {};
     ...
     */
    /* eslint-disable-next-line @typescript-eslint/no-unused-vars */
    PerformanceClient.prototype.startPerformanceMeasuremeant = function (
      measureName,
      correlationId
    ) {
      return {};
     ...
     * @returns {number}
     */
    PerformanceClient.prototype.getPreQueueTime = function (
      eventName,
      correlationId
    ) {
      var preQueueTimesByEvents =
     ...
     * @returns {number}
     */
    PerformanceClient.prototype.calculateQueuedTime = function (
      preQueueTime,
      currentTime
    ) {
      if (preQueueTime < 1) {
     ...
     * @returns
     */
    PerformanceClient.prototype.addQueueMeasurement = function (
      eventName,
      correlationId,
      queueTime
    ) {
     ...
     */
    PerformanceClient.prototype.startMeasurement = function (
      measureName,
      correlationId
    ) {
      var _this = this;
      ...
      var performanceMeasuremeant = this.startPerformanceMeasuremeant(
        measureName,
        eventCorrelationId
      );
      if (performanceMeasuremeant.startMeasurement) {
        ...
        var performanceMeasurement = this.startPerformanceMeasurement(
          measureName,
          eventCorrelationId
        );
      ...
      var staticFields = {
        appName:
          (_a = this.applicationTelemetry) === null || _a === void 0
            ? void 0
            : _a.appName,
        appVersion:
          (_b = this.applicationTelemetry) === null || _b === void 0
            ? void 0
            : _b.appVersion,
      };
      ...
      return {
        endMeasurement: function (event) {
          var completedEvent = _this.endMeasurement(
            __assign(__assign({}, inProgressEvent), event)
          );
          if (completedEvent) {
        ...
        flushMeasurement: function () {
          return _this.flushMeasurements(
     ...
     * @param correlationId
     */
    PerformanceClient.prototype.addStaticFields = function (
      fields,
      correlationId
    ) {
      var existingStaticFields =
        this.staticFieldsByCorrelationId.get(correlationId);
      if (existingStaticFields) {
        this.logger.trace("PerformanceClient: Updating static fields");
        this.staticFieldsByCorrelationId.set(
          correlationId,
          __assign(__assign({}, existingStaticFields), fields)
        );
      } else {
    ...
    PerformanceClient.prototype.cacheEventByCorrelationId = function (event) {
      ...
      if (existingEvents) {
        ...
        this.eventsByCorrelationId.set(
          event.correlationId,
          new Map().set(event.eventId, event)
        );
      }
    };
    /**
     ...
     */
    PerformanceClient.prototype.cacheMeasurement = function (
      event,
      measurement
    ) {
     ...
     * @param {string} correlationId
     */
    PerformanceClient.prototype.flushMeasurements = function (
      measureName,
      correlationId
    ) {
      var _this = this;
      this.logger.trace(
        "PerformanceClient: Performance measurements flushed for " +
          measureName,
        correlationId
      );
      /**
       ...
       */
      var queueMeasurementForCorrelationId =
      ...
      queueMeasurementForCorrelationId === null ||
      queueMeasurementForCorrelationId === void 0
        ? void 0
        : queueMeasurementForCorrelationId.forEach(function (measurement) {
            totalQueueTime += measurement.queueTime;
            totalQueueCount++;
          });
      var eventsForCorrelationId =
        this.eventsByCorrelationId.get(correlationId);
      ...
      if (eventsForCorrelationId) {
        ...
        var sortedCompletedEvents = completedEvents_1.sort(function (
          eventA,
          eventB
        ) {
        ...
        if (topLevelEvents.length > 0) {
          ...
          this.logger.verbose(
            "PerformanceClient: Measurement found for " + measureName,
            correlationId
          );
          // Build event object with top level and sub measurements
          var eventToEmit = sortedCompletedEvents.reduce(function (
            previous,
            current
          ) {
            if (current.name !== measureName) {
              _this.logger.trace(
                "PerformanceClient: Complete submeasurement found for " +
                  current.name,
                correlationId
              );
              ...
              if (!previous[subMeasurementName]) {
                ...
                _this.logger.verbose(
                  "PerformanceClient: Submeasurement for " +
                    measureName +
                    " already exists for " +
                    current.name +
                    ", ignoring",
          ...
          topLevelEvent);
          var finalEvent = __assign(
            __assign(
              __assign(__assign({}, eventToEmit), staticFields),
              counters
            ),
            {
          ...
          this.logger.verbose(
            "PerformanceClient: No completed top-level measurements found for " +
              measureName,
            correlationId
          );
        }
        ...
        this.logger.verbose(
          "PerformanceClient: No measurements found",
          correlationId
        );
      }
    };
    ...
    PerformanceClient.prototype.discardCache = function (correlationId) {
      ...
      this.logger.trace(
        "PerformanceClient: Static fields discarded",
        correlationId
      );
     ...
     * @returns {boolean}
     */
    PerformanceClient.prototype.removePerformanceCallback = function (
      callbackId
    ) {
     ...
     */
    PerformanceClient.prototype.truncateIntegralFields = function (
      event,
      intFields
    ) {
  ...
  var StubPerformanceClient = /** @class */ (function (_super) {
    ...
    /* eslint-disable-next-line @typescript-eslint/no-unused-vars */
    StubPerformanceClient.prototype.calculateQueuedTime = function (
      preQueueTime,
      currentTime
    ) {
      return 0;
    ...
    /* eslint-disable-next-line @typescript-eslint/no-unused-vars */
    StubPerformanceClient.prototype.addQueueMeasurement = function (
      eventName,
      correlationId,
      queueTime
    ) {
    ...
    /* eslint-disable-next-line @typescript-eslint/no-unused-vars */
    StubPerformanceClient.prototype.setPreQueueTime = function (
      eventName,
      correlationId
    ) {
      return;
  ...
  var BrowserAuthError = /** @class */ (function (_super) {
     ...
     */
    BrowserAuthError.createRedirectInIframeError = function (
      windowParentCheck
    ) {
      return new BrowserAuthError(
     ...
     */
    BrowserAuthError.createUnableToAcquireTokenFromNativePlatformError =
      function () {
        return new BrowserAuthError(
     ...
     */
    BrowserAuthError.createNativePromptParameterNotSupportedError =
      function () {
        return new BrowserAuthError(
  ...
  (function (CacheLookupPolicy) {
     ...
     */
    CacheLookupPolicy[(CacheLookupPolicy["AccessTokenAndRefreshToken"] = 2)] =
     ...
     */
    CacheLookupPolicy[(CacheLookupPolicy["RefreshTokenAndNetwork"] = 4)] =
  ...
  var BrowserStorage = /** @class */ (function () {
    ...
    BrowserStorage.prototype.validateWindowStorage = function (cacheLocation) {
      if (
        cacheLocation !== exports.BrowserCacheLocation.LocalStorage &&
  ...
  var BrowserCacheManager = /** @class */ (function (_super) {
     ...
     * @param cacheLocation
     */
    BrowserCacheManager.prototype.setupBrowserStorage = function (
      cacheLocation
    ) {
     ...
     */
    BrowserCacheManager.prototype.setWrapperMetadata = function (
      wrapperSKU,
      wrapperVersion
    ) {
     ...
     * @param entity
     */
    BrowserCacheManager.prototype.setAuthorityMetadata = function (
      key,
      entity
    ) {
    ...
    BrowserCacheManager.prototype.getActiveAccount = function () {
      var activeAccountKeyFilters = this.generateCacheKey(
      ...
      if (!activeAccountValueFilters) {
        ...
        var activeAccountKeyLocal = this.generateCacheKey(
      ...
      var activeAccountValueObj = this.validateAndParseJson(
    ...
    BrowserCacheManager.prototype.setActiveAccount = function (account) {
      var activeAccountKey = this.generateCacheKey(
        PersistentCacheKeys.ACTIVE_ACCOUNT_FILTERS
      );
      var activeAccountKeyLocal = this.generateCacheKey(
        PersistentCacheKeys.ACTIVE_ACCOUNT
     ...
     * @param sid
     */
    BrowserCacheManager.prototype.getAccountInfoByHints = function (
      loginHint,
      sid
    ) {
      var matchingAccounts = this.getAllAccounts().filter(function (
        accountInfo
      ) {
        if (sid) {
          var accountSid =
            accountInfo.idTokenClaims && accountInfo.idTokenClaims["sid"];
     ...
     * @param state
     */
    BrowserCacheManager.prototype.generateAuthorityKey = function (
      stateString
    ) {
      var stateId = ProtocolUtils.parseRequestState(
        this.cryptoImpl,
        stateString
      ).libraryState.id;
    ...
    BrowserCacheManager.prototype.getCachedNativeRequest = function () {
      ...
      var cachedRequest = this.getTemporaryCache(
    ...
    BrowserCacheManager.prototype.isInteractionInProgress = function (
      matchClientId
    ) {
    ...
    BrowserCacheManager.prototype.setInteractionInProgress = function (
      inProgress
    ) {
    ...
    BrowserCacheManager.prototype.getLegacyLoginHint = function () {
      ...
      var adalIdTokenString = this.getTemporaryCache(
      ...
      var msalIdTokenString = this.getTemporaryCache(
        PersistentCacheKeys.ID_TOKEN,
        true
      );
     ...
     */
    BrowserCacheManager.prototype.updateCredentialCacheKey = function (
      currentCacheKey,
      credential
    ) {
      ...
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_b) {
          switch (_b.label) {
            ...
            case 5:
              _b.sent();
              throw BrowserAuthError.createFailedToParseNetworkResponseError(
                url
              );
            case 6:
              return [2 /*return*/];
      ...
      return new Promise(function (resolve, reject) {
        ...
        xhr.onload = function () {
          ...
          try {
            ...
            reject(
              BrowserAuthError.createFailedToParseNetworkResponseError(url)
            );
          }
        };
  ...
  var BrowserUtils = /** @class */ (function () {
    ...
    BrowserUtils.getHomepage = function () {
      ...
      return (
        urlComponents.Protocol + "//" + urlComponents.HostNameAndPort + "/"
      );
    };
    /**
     ...
     * @param initialized
     */
    BrowserUtils.blockNativeBrokerCalledBeforeInitialized = function (
      allowNativeBroker,
      initialized
    ) {
  ...
  var BaseInteractionClient = /** @class */ (function () {
    function BaseInteractionClient(
      config,
      storageImpl,
      browserCrypto,
      logger,
          ...
          switch (_b.label) {
            case 0:
              this.performanceClient.addQueueMeasurement(
                exports.PerformanceEvents.InitializeBaseRequest,
                request.correlationId
              );
     ...
     *
     */
    BaseInteractionClient.prototype.getRedirectUri = function (
      requestRedirectUri
    ) {
     ...
     * @param forceRefresh
     */
    BaseInteractionClient.prototype.initializeServerTelemetryManager =
      function (apiId, forceRefresh) {
     ...
     */
    BaseInteractionClient.prototype.getDiscoveredAuthority = function (
      requestAuthority
    ) {
      return __awaiter$1(this, void 0, void 0, function () {
  ...
  var StandardInteractionClient = /** @class */ (function (_super) {
     ...
     * @param request
     */
    StandardInteractionClient.prototype.initializeAuthorizationCodeRequest =
      function (request) {
        return __awaiter$1(this, void 0, void 0, function () {
     ...
     * @param logoutRequest
     */
    StandardInteractionClient.prototype.initializeLogoutRequest = function (
      logoutRequest
    ) {
      this.logger.verbose(
      ...
      if (logoutRequest) {
        ...
        if (!logoutRequest.logoutHint) {
          if (logoutRequest.account) {
            var logoutHint = this.getLogoutHintFromIdTokenClaims(
     ...
     * @param account
     */
    StandardInteractionClient.prototype.getLogoutHintFromIdTokenClaims =
      function (account) {
     ...
     * @param authorityUrl
     */
    StandardInteractionClient.prototype.createAuthCodeClient = function (
      serverTelemetryManager,
      authorityUrl,
     ...
     * @param requestCorrelationId
     */
    StandardInteractionClient.prototype.getClientConfiguration = function (
      serverTelemetryManager,
      requestAuthority,
      requestAzureCloudOptions
    ) {
     ...
     * @param interactionType
     */
    StandardInteractionClient.prototype.validateAndExtractStateFromHash =
      function (serverParams, interactionType, requestCorrelationId) {
        this.logger.verbose(
     ...
     * @param requestCorrelationId
     */
    StandardInteractionClient.prototype.getDiscoveredAuthority = function (
      requestAuthority,
      requestAzureCloudOptions
    ) {
      var _a;
      return __awaiter$1(this, void 0, void 0, function () {
        var getAuthorityMeasurement,
          authorityOptions,
          userAuthority,
          builtAuthority;
        return __generator$1(this, function (_b) {
          switch (_b.label) {
            case 0:
              ...
              userAuthority = requestAuthority
                ? requestAuthority
                : this.config.auth.authority;
              builtAuthority = Authority.generateAuthority(
                userAuthority,
     ...
     * @param interactionType
     */
    StandardInteractionClient.prototype.initializeAuthorizationRequest =
      function (request, interactionType) {
        return __awaiter$1(this, void 0, void 0, function () {
          var redirectUri,
            browserState,
            state,
          ...
          return __generator$1(this, function (_b) {
            switch (_b.label) {
              case 0:
                ...
                state = ProtocolUtils.setRequestState(
                  this.browserCrypto,
              ...
              case 1:
                ...
                if (
                  StringUtils.isEmpty(validatedRequest.loginHint) &&
                  !account
                ) {
  ...
  var InteractionHandler = /** @class */ (function () {
     ...
     * @param locationHash
     */
    InteractionHandler.prototype.handleCodeResponseFromHash = function (
      locationHash,
      state,
      authority,
      networkModule
      ...
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
          this.performanceClient.addQueueMeasurement(
            exports.PerformanceEvents.HandleCodeResponseFromHash,
          ...
          this.performanceClient.setPreQueueTime(
            exports.PerformanceEvents.HandleCodeResponseFromServer,
            this.authCodeRequest.correlationId
          );
          return [
            2 /*return*/,
            this.handleCodeResponseFromServer(
              authCodeResponse,
              state,
              authority,
              networkModule
     ...
     * @returns
     */
    InteractionHandler.prototype.handleCodeResponseFromServer = function (
      authCodeResponse,
      state,
      authority,
      networkModule,
          ...
          switch (_a.label) {
            case 0:
              ...
              if (!authCodeResponse.cloud_instance_host_name)
                return [3 /*break*/, 2];
              this.performanceClient.setPreQueueTime(
                exports.PerformanceEvents.UpdateTokenEndpointAuthority,
                this.authCodeRequest.correlationId
              );
              return [
                4 /*yield*/,
  ...
  var RedirectHandler = /** @class */ (function (_super) {
     ...
     * @param hash
     */
    RedirectHandler.prototype.handleCodeResponseFromHash = function (
      locationHash,
      state,
      authority,
      networkModule
  ...
  (function (EventType) {
    ...
    EventType["ACQUIRE_TOKEN_BY_CODE_SUCCESS"] =
      "msal:acquireTokenByCodeSuccess";
  ...
  var SilentCacheClient = /** @class */ (function (_super) {
    ...
    SilentCacheClient.prototype.acquireToken = function (silentRequest) {
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
          switch (_a.label) {
            case 0:
              acquireTokenMeasurement = this.performanceClient.startMeasurement(
                exports.PerformanceEvents.SilentCacheClientAcquireToken,
                silentRequest.correlationId
              );
              serverTelemetryManager = this.initializeServerTelemetryManager(
                exports.ApiId.acquireTokenSilent_silentFlow
              );
              return [
                4 /*yield*/,
            ...
            case 4:
              error_1 = _a.sent();
              if (
                error_1 instanceof BrowserAuthError &&
                error_1.errorCode ===
                  BrowserAuthErrorMessage.signingKeyNotFoundInStorage.code
              ) {
                this.logger.verbose(
              ...
              acquireTokenMeasurement.endMeasurement({
                errorCode:
                  (error_1 instanceof AuthError && error_1.errorCode) ||
                  undefined,
                subErrorCode:
                  (error_1 instanceof AuthError && error_1.subError) ||
                  undefined,
                success: false,
              });
              throw error_1;
     ...
     * @param authorityUrl
     */
    SilentCacheClient.prototype.createSilentFlowClient = function (
      serverTelemetryManager,
      authorityUrl,
      azureCloudOptions
    ) {
      ...
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_b) {
          switch (_b.label) {
            case 0:
              this.performanceClient.addQueueMeasurement(
                exports.PerformanceEvents.InitializeSilentRequest,
                this.correlationId
              );
              this.performanceClient.setPreQueueTime(
                exports.PerformanceEvents.InitializeBaseRequest,
  ...
  var NativeInteractionClient = /** @class */ (function (_super) {
    ...
    function NativeInteractionClient(
      config,
      browserStorage,
      browserCrypto,
      logger,
      ...
      _this.silentCacheClient = new SilentCacheClient(
        config,
        _this.nativeStorageManager,
        browserCrypto,
        logger,
        eventHandler,
        navigationClient,
        ...
        return __generator$1(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              nativeATMeasurement = this.performanceClient.startMeasurement(
                exports.PerformanceEvents.NativeInteractionClientAcquireToken,
                request.correlationId
              );
              reqTimestamp = TimeUtils.nowSeconds();
     ...
     */
    NativeInteractionClient.prototype.createSilentCacheRequest = function (
      request,
      cachedAccount
    ) {
      return {
     ...
     */
    NativeInteractionClient.prototype.acquireTokensFromCache = function (
      nativeAccountId,
      request
    ) {
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
          switch (_a.label) {
            case 0:
              accountEntity =
                this.browserStorage.readAccountFromCacheWithNativeAccountId(
                  nativeAccountId
                );
              if (!accountEntity) {
                throw ClientAuthError.createNoAccountFoundError();
     ...
     * @param request
     */
    NativeInteractionClient.prototype.acquireTokenRedirect = function (
      request
    ) {
      return __awaiter$1(this, void 0, void 0, function () {
        var nativeRequest,
        ...
        return __generator$1(this, function (_a) {
          switch (_a.label) {
            ...
            case 5:
              ...
              redirectUri = this.config.auth.navigateToLoginRequestUrl
        ...
        return __generator$1(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              (prompt = cachedRequest.prompt),
                (request = __rest(cachedRequest, ["prompt"]));
              if (prompt) {
                this.logger.verbose(
            ...
            case 2:
              response = _a.sent();
              this.validateNativeResponse(response);
              result = this.handleNativeResponse(
                response,
                request,
                reqTimestamp
              );
     ...
     * @param reqTimestamp
     */
    NativeInteractionClient.prototype.handleNativeResponse = function (
      response,
      request,
      reqTimestamp
    ) {
        ...
        return __generator$1(this, function (_b) {
          switch (_b.label) {
              ...
              this.performanceClient.addStaticFields(
                {
                  ...
                  matsAccountJoinOnStart: mats
                    ? mats.account_join_on_start
                    : undefined,
                  matsAccountJoinOnEnd: mats
                    ? mats.account_join_on_end
                    : undefined,
                  ...
                  matsSilentBiSubCode: mats
                    ? mats.silent_bi_sub_code
                    : undefined,
            ...
            case 1:
              ...
              homeAccountIdentifier = AccountEntity.generateHomeAccountId(
            ...
            case 5:
              ...
              this.nativeStorageManager.setAccessTokenCredential(
                accessTokenEntity
              );
     ...
     * @param response
     */
    NativeInteractionClient.prototype.validateNativeResponse = function (
      response
    ) {
      if (
     ...
     * @returns
     */
    NativeInteractionClient.prototype.getMATSFromResponse = function (
      response
    ) {
     ...
     * @param request
     */
    NativeInteractionClient.prototype.initializeNativeRequest = function (
      request
    ) {
      return __awaiter$1(this, void 0, void 0, function () {
        var authority,
        ...
        return __generator$1(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              (scopes = request.scopes),
                (remainingProperties = __rest(request, ["scopes"]));
              ...
              validatedRequest = __assign$1(
                __assign$1({}, remainingProperties),
                {
                  ...
                  extraParameters: __assign$1(
                    __assign$1(
                      __assign$1({}, request.extraQueryParameters),
  ...
  var NativeMessageHandler = /** @class */ (function () {
     ...
     */
    NativeMessageHandler.createProvider = function (
      logger,
      handshakeTimeoutMs
    ) {
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              _a.trys.push([1, 3, , 5]);
              preferredProvider = new NativeMessageHandler(
                logger,
                handshakeTimeoutMs,
            ...
            case 3:
              _a.sent();
              backupProvider = new NativeMessageHandler(
                logger,
                handshakeTimeoutMs
              );
    ...
    NativeMessageHandler.prototype.onChannelMessage = function (event) {
      ...
      try {
        ...
        this.logger.errorPii(
          "Error parsing response from WAM Extension: " + err.toString()
        );
     ...
     */
    NativeMessageHandler.isNativeAvailable = function (
      config,
      logger,
  ...
  var RedirectClient = /** @class */ (function (_super) {
     ...
     * @param state
     */
    RedirectClient.prototype.handleHash = function (
      hash,
      state,
      serverTelemetryManager
    ) {
          ...
          switch (_a.label) {
            case 0:
              ...
              if (serverParams.accountId) {
                ...
                userRequestState = ProtocolUtils.parseRequestState(
                  this.browserCrypto,
                  state
                ).userRequestState;
                return [
        ...
        return __generator$1(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              serverTelemetryManager = this.initializeServerTelemetryManager(
                exports.ApiId.logout
              );
              _a.label = 1;
            case 1:
              _a.trys.push([1, 10, , 11]);
              this.eventHandler.emitEvent(
                exports.EventType.LOGOUT_START,
                exports.InteractionType.Redirect,
                logoutRequest
              );
            ...
            case 3:
              ...
              this.eventHandler.emitEvent(
                exports.EventType.LOGOUT_SUCCESS,
                exports.InteractionType.Redirect,
                validLogoutRequest
              );
              if (
            ...
            case 10:
              ...
              this.eventHandler.emitEvent(
                exports.EventType.LOGOUT_FAILURE,
                exports.InteractionType.Redirect,
                null,
                e_3
              );
              this.eventHandler.emitEvent(
                exports.EventType.LOGOUT_END,
                exports.InteractionType.Redirect
              );
              throw e_3;
            case 11:
     ...
     */
    RedirectClient.prototype.getRedirectStartPage = function (
      requestStartPage
    ) {
  ...
  var PopupClient = /** @class */ (function (_super) {
    ...
    PopupClient.prototype.acquireToken = function (request) {
      try {
        var popupName = this.generatePopupName(
        ...
        return __generator$1(this, function (_a) {
          switch (_a.label) {
              ...
              if (isNativeBroker) {
                fetchNativeAccountIdMeasurement =
                  this.performanceClient.startMeasurement(
                    exports.PerformanceEvents.FetchAccountIdWithNativeBroker,
                    request.correlationId
                  );
              }
              return [
            ...
            case 5:
              ...
              popupWindow = this.initiateAuthRequest(
                navigateUrl,
                popupParameters
              );
              this.eventHandler.emitEvent(
            ...
            case 6:
              hash = _a.sent();
              serverParams = UrlString.getDeserializedHash(hash);
              state_1 = this.validateAndExtractStateFromHash(
                serverParams,
                exports.InteractionType.Popup,
     ...
     * @param popupWindowAttributes
     */
    PopupClient.prototype.logoutPopupAsync = function (
      validRequest,
      popupName,
      popupWindowAttributes,
      requestAuthority,
    ...
    PopupClient.prototype.monitorPopupForHash = function (popupWindow) {
      ...
      return new Promise(function (resolve, reject) {
         ...
         */
        var maxTicks =
          _this.config.system.windowHashTimeout /
     ...
     * @returns
     */
    PopupClient.prototype.openSizedPopup = function (
      urlNavigate,
      popupName,
      popupWindowAttributes
    ) {
      ...
      var width =
        (_a = popupWindowAttributes.popupSize) === null || _a === void 0
          ? void 0
          : _a.width;
      var height =
        (_b = popupWindowAttributes.popupSize) === null || _b === void 0
          ? void 0
          : _b.height;
      var top =
        (_c = popupWindowAttributes.popupPosition) === null || _c === void 0
          ? void 0
          : _c.top;
      var left =
        (_d = popupWindowAttributes.popupPosition) === null || _d === void 0
          ? void 0
          : _d.left;
  ...
  function buildConfiguration(_a, isBrowserEnvironment) {
    ...
    var DEFAULT_BROWSER_SYSTEM_OPTIONS = __assign$1(
      __assign$1({}, DEFAULT_SYSTEM_OPTIONS),
      {
        ...
        windowHashTimeout:
          (userInputSystem === null || userInputSystem === void 0
            ? void 0
    ...
    var providedSystemOptions = __assign$1(__assign$1({}, userInputSystem), {
      loggerOptions:
        (userInputSystem === null || userInputSystem === void 0
          ? void 0
          : userInputSystem.loggerOptions) || DEFAULT_LOGGER_OPTIONS,
    });
    var DEFAULT_TELEMETRY_OPTIONS = {
      application: {
    ...
    var overlayedConfig = {
      ...
      system: __assign$1(
        __assign$1({}, DEFAULT_BROWSER_SYSTEM_OPTIONS),
        providedSystemOptions
      ),
      telemetry: __assign$1(
        __assign$1({}, DEFAULT_TELEMETRY_OPTIONS),
        userInputTelemetry
      ),
    };
  ...
  var SilentHandler = /** @class */ (function (_super) {
      ...
      return __awaiter$1(this, void 0, void 0, function () {
        return __generator$1(this, function (_a) {
          switch (_a.label) {
            case 0:
              this.performanceClient.addQueueMeasurement(
                exports.PerformanceEvents.SilentHandlerInitiateAuthRequest,
                this.authCodeRequest.correlationId
              );
              if (StringUtils.isEmpty(requestUrl)) {
                // Throw error if request URL is empty.
              ...
              this.performanceClient.setPreQueueTime(
                exports.PerformanceEvents.SilentHandlerLoadFrame,
                this.authCodeRequest.correlationId
              );
    ...
    SilentHandler.prototype.monitorIframeForHash = function (iframe, timeout) {
      var _this = this;
      this.performanceClient.addQueueMeasurement(
        exports.PerformanceEvents.SilentHandlerMonitorIframeForHash,
        this.authCodeRequest.correlationId
      );
      return new Promise(function (resolve, reject) {
      ...
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
          switch (_a.label) {
            case 0:
              this.performanceClient.addQueueMeasurement(
                exports.PerformanceEvents.SilentIframeClientAcquireToken,
                request.correlationId
              );
            ...
            case 3:
              ...
              this.logger.verbose("Auth code client created");
              this.performanceClient.setPreQueueTime(
                exports.PerformanceEvents.SilentIframeClientTokenHelper,
                request.correlationId
              );
              return [
                4 /*yield*/,
                this.silentTokenHelper(authClient, silentRequest).then(
                  function (result) {
                    acquireTokenMeasurement.endMeasurement({
                      success: true,
                      fromCache: false,
            ...
            case 5:
              ...
              acquireTokenMeasurement.endMeasurement({
                errorCode:
                  (e_1 instanceof AuthError && e_1.errorCode) || undefined,
                subErrorCode:
                  (e_1 instanceof AuthError && e_1.subError) || undefined,
                success: false,
              });
              throw e_1;
            case 6:
        ...
        return __generator$1(this, function (_a) {
          switch (_a.label) {
            ...
            case 4:
              ...
              return [
                2 /*return*/,
                silentHandler.handleCodeResponseFromHash(
                  hash,
                  state,
                  authClient.authority,
                  this.networkClient
  ...
  var SilentRefreshClient = /** @class */ (function (_super) {
      ...
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_b) {
          switch (_b.label) {
            case 0:
              this.performanceClient.addQueueMeasurement(
                exports.PerformanceEvents.SilentRefreshClientAcquireToken,
                request.correlationId
              );
              this.performanceClient.setPreQueueTime(
                exports.PerformanceEvents.InitializeBaseRequest,
     ...
     * @param authorityUrl
     */
    SilentRefreshClient.prototype.createRefreshTokenClient = function (
      serverTelemetryManager,
      authorityUrl,
      azureCloudOptions
    ) {
  ...
  var EventHandler = /** @class */ (function () {
     ...
     * @param error
     */
    EventHandler.prototype.emitEvent = function (
      eventType,
      interactionType,
      payload,
      error
    ...
    EventHandler.prototype.handleAccountCacheChange = function (e) {
      try {
        ...
        var accountEntity = CacheManager.toObject(
          new AccountEntity(),
          parsedValue
        );
        var accountInfo = accountEntity.getAccountInfo();
        if (!e.oldValue && e.newValue) {
          ...
          this.emitEvent(
            exports.EventType.ACCOUNT_ADDED,
            undefined,
            accountInfo
          );
          ...
          this.emitEvent(
            exports.EventType.ACCOUNT_REMOVED,
            undefined,
            accountInfo
          );
        }
  ...
  var BrowserStringUtils = /** @class */ (function () {
    ...
    BrowserStringUtils.utf8ArrToString = function (aBytes) {
      ...
      for (
        var nPart = void 0, nLen = aBytes.length, nIdx = 0;
        nIdx < nLen;
        nIdx++
      ) {
        nPart = aBytes[nIdx];
  ...
  var Base64Encode = /** @class */ (function () {
    ...
    Base64Encode.prototype.base64EncArr = function (aBytes) {
      ...
      for (
        var nMod3 = void 0, nLen = aBytes.length, nUint24 = 0, nIdx = 0;
        nIdx < nLen;
        nIdx++
      ) {
        nMod3 = nIdx % 3;
  ...
  var Base64Decode = /** @class */ (function () {
     ...
     * @param nBlockSize
     */
    Base64Decode.prototype.base64DecToArr = function (
      base64String,
      nBlockSize
    ) {
      var sB64Enc = base64String.replace(
        /[^A-Za-z0-9\+\/]/g,
        Constants.EMPTY_STRING
      );
  ...
  var PkceGenerator = /** @class */ (function () {
     ...
     */
    PkceGenerator.prototype.generateCodeChallengeFromVerifier = function (
      pkceCodeVerifier
    ) {
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                2 /*return*/,
                this.base64Encode.urlEncodeArr(
  ...
  var ModernBrowserCrypto = /** @class */ (function () {
    ...
    ModernBrowserCrypto.prototype.generateKey = function (
      algorithm,
      extractable,
      keyUsages
    ) {
    ...
    ModernBrowserCrypto.prototype.importKey = function (
      keyData,
      algorithm,
      extractable,
      keyUsages
  ...
  var MsrBrowserCrypto = /** @class */ (function () {
    ...
    MsrBrowserCrypto.prototype.generateKey = function (
      algorithm,
      extractable,
      keyUsages
    ) {
    ...
    MsrBrowserCrypto.prototype.importKey = function (
      keyData,
      algorithm,
      extractable,
      keyUsages
      ...
      return __awaiter$1(this, void 0, void 0, function () {
        return __generator$1(this, function (_a) {
          return [
            2 /*return*/,
            window.msrCrypto.subtle.importKey(
              KEY_FORMAT_JWK,
              keyData,
              algorithm,
              extractable,
  ...
  var MsBrowserCrypto = /** @class */ (function () {
    ...
    MsBrowserCrypto.prototype.generateKey = function (
      algorithm,
      extractable,
      keyUsages
    ) {
      ...
      return __awaiter$1(this, void 0, void 0, function () {
        return __generator$1(this, function (_a) {
          return [
            2 /*return*/,
            new Promise(function (resolve, reject) {
              var msExportKey = window["msCrypto"].subtle.exportKey(
                KEY_FORMAT_JWK,
                key
              );
              msExportKey.addEventListener("complete", function (e) {
                var resultBuffer = e.target.result;
                var resultString = BrowserStringUtils.utf8ArrToString(
    ...
    MsBrowserCrypto.prototype.importKey = function (
      keyData,
      algorithm,
      extractable,
      keyUsages
      ...
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
          ...
          return [
            2 /*return*/,
            new Promise(function (resolve, reject) {
              var msImportKey = window["msCrypto"].subtle.importKey(
                KEY_FORMAT_JWK,
                keyBuffer,
                algorithm,
                extractable,
      ...
      return __awaiter$1(this, void 0, void 0, function () {
        return __generator$1(this, function (_a) {
          return [
            2 /*return*/,
            new Promise(function (resolve, reject) {
              var digestOperation = window["msCrypto"].subtle.digest(
                algorithm,
                data.buffer
              );
  ...
  var BrowserCrypto = /** @class */ (function () {
    function BrowserCrypto(logger, cryptoOptions) {
      ...
      if (this.hasBrowserCrypto()) {
        ...
        this.hasMsrCrypto() &&
        ((_a = this.cryptoOptions) === null || _a === void 0
          ? void 0
          : _a.useMsrCrypto)
      ) {
      ...
      if (this.subtleCrypto.initPrng) {
        ...
        if (
          !((_b = this.cryptoOptions) === null || _b === void 0
            ? void 0
            : _b.entropy)
        ) {
          this.logger.error(
    ...
    BrowserCrypto.prototype.sha256Digest = function (dataString) {
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
          ...
          return [
            2 /*return*/,
            this.subtleCrypto.digest({ name: S256_HASH_ALG }, data),
          ];
        });
      });
    };
            ...
            case 1:
              ...
              return [
                ...
                new Promise(function (resolve, reject) {
                  ...
                  if (!_this.db) {
                    return reject(
                      BrowserAuthError.createDatabaseNotOpenError()
                    );
                  }
          ...
          switch (_a.label) {
            ...
            case 3:
              ...
              if (e_1 instanceof Error) {
                this.logger.error(
                  "Clearing keystore failed with error: " + e_1.message
                );
              } else {
                this.logger.error(
        ...
        return __generator$1(this, function (_b) {
          switch (_b.label) {
            case 0:
              signJwtMeasurement =
                (_a = this.performanceClient) === null || _a === void 0
                  ? void 0
                  : _a.startMeasurement(
                      exports.PerformanceEvents.CryptoOptsSignJwt,
                      correlationId
                    );
            ...
            case 2:
              ...
              encodedPayload = this.b64Encode.urlEncode(
            ...
            case 3:
              ...
              encodedSignature = this.b64Encode.urlEncodeArr(
  ...
  var BrowserPerformanceMeasurement = /** @class */ (function () {
    ...
    BrowserPerformanceMeasurement.prototype.flushMeasurement = function () {
      if (BrowserPerformanceMeasurement.supportsBrowserPerformance()) {
        try {
          var entriesForMeasurement = window.performance.getEntriesByName(
            this.measureName,
            "measure"
          );
  ...
  var BrowserPerformanceClient = /** @class */ (function (_super) {
    ...
    function BrowserPerformanceClient(
      clientId,
      authority,
      logger,
      libraryName,
    ...
    BrowserPerformanceClient.prototype.startPerformanceMeasuremeant = function (
      measureName,
      correlationId
    ) {
    ...
    BrowserPerformanceClient.prototype.getPageVisibility = function () {
      var _a;
      return (
        ((_a = document.visibilityState) === null || _a === void 0
          ? void 0
          : _a.toString()) || null
      );
    };
    BrowserPerformanceClient.prototype.supportsBrowserPerformanceNow =
      function () {
        return (
          typeof window !== "undefined" &&
          typeof window.performance !== "undefined" &&
     ...
     */
    BrowserPerformanceClient.prototype.startMeasurement = function (
      measureName,
      correlationId
    ) {
      var _this = this;
      ...
      var inProgressEvent = _super.prototype.startMeasurement.call(
        this,
        measureName,
        correlationId
      );
     ...
     * @returns
     */
    BrowserPerformanceClient.prototype.setPreQueueTime = function (
      eventName,
      correlationId
    ) {
     ...
     * @returns
     */
    BrowserPerformanceClient.prototype.addQueueMeasurement = function (
      eventName,
      correlationId
    ) {
      if (!this.supportsBrowserPerformanceNow()) {
      ...
      var preQueueTime = _super.prototype.getPreQueueTime.call(
        this,
        eventName,
        correlationId
      );
      ...
      var queueTime = _super.prototype.calculateQueuedTime.call(
        this,
        preQueueTime,
        currentTime
      );
      return _super.prototype.addQueueMeasurement.call(
        this,
        eventName,
        correlationId,
        queueTime
  ...
  var TokenCache = /** @class */ (function () {
     ...
     */
    TokenCache.prototype.loadExternalTokens = function (
      request,
      response,
      options
    ) {
      ...
      var authority;
      if (request.account) {
        var cacheRecordAccount = this.loadAccount(
          idToken,
          request.account.environment,
          undefined,
          undefined,
        ...
        var authorityUrl = Authority.generateAuthority(
          request.authority,
     ...
     */
    TokenCache.prototype.loadAccount = function (
      idToken,
      environment,
      clientInfo,
      authorityType,
     ...
     */
    TokenCache.prototype.loadIdToken = function (
      idToken,
      homeAccountId,
      environment,
      tenantId
    ) {
      var idTokenEntity = IdTokenEntity.createIdTokenEntity(
        homeAccountId,
        environment,
        idToken.rawToken,
        this.config.auth.clientId,
     ...
     */
    TokenCache.prototype.loadAccessToken = function (
      request,
      response,
      homeAccountId,
      environment,
     ...
     */
    TokenCache.prototype.loadRefreshToken = function (
      request,
      response,
      homeAccountId,
      environment
      ...
      var refreshTokenEntity = RefreshTokenEntity.createRefreshTokenEntity(
        homeAccountId,
        environment,
     ...
     * @returns `AuthenticationResult`
     */
    TokenCache.prototype.generateAuthenticationResult = function (
      request,
      idTokenObj,
      cacheRecord,
      authority
      ...
      var extExpiresOn;
      if (
        cacheRecord === null || cacheRecord === void 0
          ? void 0
      ...
      return {
        ...
        tokenType:
          ((_a =
            cacheRecord === null || cacheRecord === void 0
              ? void 0
              : cacheRecord.accessToken) === null || _a === void 0
            ? void 0
            : _a.tokenType) || Constants.EMPTY_STRING,
        ...
        cloudGraphHostName:
          ((_b =
            cacheRecord === null || cacheRecord === void 0
              ? void 0
              : cacheRecord.account) === null || _b === void 0
            ? void 0
            : _b.cloudGraphHostName) || Constants.EMPTY_STRING,
        msGraphHost:
          ((_c =
            cacheRecord === null || cacheRecord === void 0
              ? void 0
              : cacheRecord.account) === null || _c === void 0
            ? void 0
            : _c.msGraphHost) || Constants.EMPTY_STRING,
        code: undefined,
        fromNativeBroker: false,
  ...
  var ClientApplication = /** @class */ (function () {
        ...
        return __generator$1(this, function (_a) {
          ...
          if (this.isBrowserEnvironment) {
            ...
            if (typeof response === "undefined") {
              this.eventHandler.emitEvent(
                exports.EventType.HANDLE_REDIRECT_START,
                exports.InteractionType.Redirect
              );
              this.logger.verbose(
              ...
              response = redirectResponse
                .then(function (result) {
                  if (result) {
                    ...
                    if (isLoggingIn) {
                      _this.eventHandler.emitEvent(
                        exports.EventType.LOGIN_SUCCESS,
                        exports.InteractionType.Redirect,
                        result
                      );
                      _this.logger.verbose(
                      ...
                      _this.eventHandler.emitEvent(
                        exports.EventType.ACQUIRE_TOKEN_SUCCESS,
                        exports.InteractionType.Redirect,
                        result
                      );
                      _this.logger.verbose(
                  ...
                  _this.eventHandler.emitEvent(
                    exports.EventType.HANDLE_REDIRECT_END,
                    exports.InteractionType.Redirect
                  );
                  return result;
                })
                .catch(function (e) {
                  ...
                  if (loggedInAccounts.length > 0) {
                    _this.eventHandler.emitEvent(
                      exports.EventType.ACQUIRE_TOKEN_FAILURE,
                      exports.InteractionType.Redirect,
                      null,
                      e
                    );
                    ...
                    _this.eventHandler.emitEvent(
                      exports.EventType.LOGIN_FAILURE,
                      exports.InteractionType.Redirect,
                      null,
                      e
                    );
    ...
    ClientApplication.prototype.acquireTokenRedirect = function (request) {
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
          ...
          if (isLoggedIn) {
            this.eventHandler.emitEvent(
              exports.EventType.ACQUIRE_TOKEN_START,
              exports.InteractionType.Redirect,
              request
            );
          } else {
            this.eventHandler.emitEvent(
              exports.EventType.LOGIN_START,
              exports.InteractionType.Redirect,
              request
            );
          }
            ...
            result = nativeClient
              ...
              .catch(function (e) {
                if (e instanceof NativeAuthError && e.isFatal()) {
                  ...
                  var redirectClient = _this.createRedirectClient(
                    request.correlationId
                  );
    ...
    ClientApplication.prototype.acquireTokenPopup = function (request) {
      ...
      var atPopupMeasurement = this.performanceClient.startMeasurement(
        exports.PerformanceEvents.AcquireTokenPopup,
        correlationId
      );
      try {
    ...
    ClientApplication.prototype.trackPageVisibilityWithMeasurement =
      function () {
        var measurement =
      ...
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_b) {
          ...
          this.ssoSilentMeasurement = this.performanceClient.startMeasurement(
            exports.PerformanceEvents.SsoSilent,
            correlationId
          );
          (_a = this.ssoSilentMeasurement) === null || _a === void 0
            ? void 0
            : _a.increment({
          ...
          this.eventHandler.emitEvent(
            exports.EventType.SSO_SILENT_START,
            exports.InteractionType.Silent,
            validRequest
          );
          if (this.canUseNative(validRequest)) {
            result = this.acquireTokenNative(
              ...
              if (e instanceof NativeAuthError && e.isFatal()) {
                _this.nativeExtensionProvider = undefined; // If extension gets uninstalled during session prevent future requests from continuing to attempt
                var silentIframeClient = _this.createSilentIframeClient(
                  validRequest.correlationId
                );
            ...
            silentIframeClient = this.createSilentIframeClient(
              validRequest.correlationId
            );
          ...
          return [
            ...
            result
              .then(function (response) {
                var _a, _b, _c;
                _this.eventHandler.emitEvent(
                  exports.EventType.SSO_SILENT_SUCCESS,
                  exports.InteractionType.Silent,
                  response
                );
                (_a = _this.ssoSilentMeasurement) === null || _a === void 0
                  ? void 0
                  : _a.addStaticFields({
                      accessTokenSize: response.accessToken.length,
                      idTokenSize: response.idToken.length,
                    });
                (_b = _this.ssoSilentMeasurement) === null || _b === void 0
                  ? void 0
                  : _b.endMeasurement({
                      success: true,
                ...
                (_c = _this.ssoSilentMeasurement) === null || _c === void 0
                  ? void 0
                  : _c.flushMeasurement();
                return response;
              })
              .catch(function (e) {
                var _a, _b;
                _this.eventHandler.emitEvent(
                  exports.EventType.SSO_SILENT_FAILURE,
                  exports.InteractionType.Silent,
                  null,
                  e
                );
              ...
              .finally(function () {
                document.removeEventListener(
                  "visibilitychange",
                  _this.trackPageVisibilityWithMeasurement
                );
              }),
          ];
        });
    ...
    ClientApplication.prototype.acquireTokenByCode = function (request) {
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
          ...
          this.eventHandler.emitEvent(
            exports.EventType.ACQUIRE_TOKEN_BY_CODE_START,
            exports.InteractionType.Silent,
            request
          );
          atbcMeasurement = this.performanceClient.startMeasurement(
            exports.PerformanceEvents.AcquireTokenByCode,
            request.correlationId
          );
          try {
            if (request.code) {
              ...
              if (!response) {
                ...
                response = this.acquireTokenByCodeAsync(
                  ...
                  .then(function (result) {
                    _this.eventHandler.emitEvent(
                      exports.EventType.ACQUIRE_TOKEN_BY_CODE_SUCCESS,
                      exports.InteractionType.Silent,
                      result
                    );
                  ...
                  .catch(function (error) {
                    _this.hybridAuthCodeResponses.delete(hybridAuthCode_1);
                    _this.eventHandler.emitEvent(
                      exports.EventType.ACQUIRE_TOKEN_BY_CODE_FAILURE,
                      exports.InteractionType.Silent,
                      null,
                      error
                    );
          ...
          switch (_b.label) {
            case 0:
              ...
              this.acquireTokenByCodeAsyncMeasurement =
                this.performanceClient.startMeasurement(
                  exports.PerformanceEvents.AcquireTokenByCodeAsync,
                  request.correlationId
                );
              (_a = this.acquireTokenByCodeAsyncMeasurement) === null ||
              _a === void 0
                ? void 0
                : _a.increment({
                    visibilityChangeCount: 0,
              ...
              silentAuthCodeClient = this.createSilentAuthCodeClient(
                request.correlationId
              );
              return [
                4 /*yield*/,
                silentAuthCodeClient
                  ...
                  .then(function (response) {
                    var _a;
                    (_a = _this.acquireTokenByCodeAsyncMeasurement) === null ||
                    _a === void 0
                      ? void 0
                      : _a.endMeasurement({
                          success: true,
     ...
     */
    ClientApplication.prototype.acquireTokenFromCache = function (
      silentCacheClient,
      commonRequest,
      silentRequest
    ) {
      return __awaiter$1(this, void 0, void 0, function () {
        return __generator$1(this, function (_a) {
          this.performanceClient.addQueueMeasurement(
            exports.PerformanceEvents.AcquireTokenFromCache,
     ...
     * @returns A promise that, when resolved, returns the access token
     */
    ClientApplication.prototype.acquireTokenByRefreshToken = function (
      commonRequest,
      silentRequest
    ) {
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
          this.performanceClient.addQueueMeasurement(
            exports.PerformanceEvents.AcquireTokenByRefreshToken,
            commonRequest.correlationId
          );
          switch (silentRequest.cacheLookupPolicy) {
            case exports.CacheLookupPolicy.Default:
            ...
            case exports.CacheLookupPolicy.RefreshTokenAndNetwork:
              silentRefreshClient = this.createSilentRefreshClient(
                commonRequest.correlationId
              );
              this.performanceClient.setPreQueueTime(
                exports.PerformanceEvents.SilentRefreshClientAcquireToken,
     ...
     * @returns A promise that, when resolved, returns the access token
     */
    ClientApplication.prototype.acquireTokenBySilentIframe = function (
      request
    ) {
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
          this.performanceClient.addQueueMeasurement(
            exports.PerformanceEvents.AcquireTokenBySilentIframe,
            request.correlationId
          );
          silentIframeClient = this.createSilentIframeClient(
            request.correlationId
      ...
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
          ...
          return [
            2 /*return*/,
            this.logoutRedirect(
              __assign$1({ correlationId: correlationId }, logoutRequest)
            ),
          ];
        });
      });
     ...
     * @returns The account object stored in MSAL
     */
    ClientApplication.prototype.getAccountByLocalId = function (
      localAccountId
    ) {
      var allAccounts = this.getAllAccounts();
      if (
     ...
     * @param request
     */
    ClientApplication.prototype.acquireTokenNative = function (
      request,
      apiId,
      accountId
    ) {
     ...
     * @param correlationId
     */
    ClientApplication.prototype.createRedirectClient = function (
      correlationId
    ) {
     ...
     * @param correlationId
     */
    ClientApplication.prototype.createSilentIframeClient = function (
      correlationId
    ) {
     ...
     */
    ClientApplication.prototype.createSilentCacheClient = function (
      correlationId
    ) {
     ...
     */
    ClientApplication.prototype.createSilentRefreshClient = function (
      correlationId
    ) {
     ...
     */
    ClientApplication.prototype.createSilentAuthCodeClient = function (
      correlationId
    ) {
     ...
     * @returns {boolean}
     */
    ClientApplication.prototype.removePerformanceCallback = function (
      callbackId
    ) {
  ...
  var PublicClientApplication = /** @class */ (function (_super) {
    ...
    PublicClientApplication.prototype.loginPopup = function (request) {
      ...
      return this.acquireTokenPopup(
        __assign$1({ correlationId: correlationId }, request || DEFAULT_REQUEST)
      );
    };
    /**
    ...
    PublicClientApplication.prototype.acquireTokenSilent = function (request) {
      return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
          correlationId = this.getRequestCorrelationId(request);
          atsMeasurement = this.performanceClient.startMeasurement(
            exports.PerformanceEvents.AcquireTokenSilent,
            correlationId
          );
          atsMeasurement.addStaticFields({
          ...
          if (typeof cachedResponse === "undefined") {
            ...
            this.performanceClient.setPreQueueTime(
              exports.PerformanceEvents.AcquireTokenSilentAsync,
              correlationId
            );
     ...
     */
    PublicClientApplication.prototype.acquireTokenSilentAsync = function (
      request,
      account
    ) {
      var _a;
        ...
        return __generator$1(this, function (_b) {
          switch (_b.label) {
            case 0:
              ...
              (_a = this.astsAsyncMeasurement) === null || _a === void 0
                ? void 0
                : _a.increment({
                    visibilityChangeCount: 0,
                  });
            ...
            case 1:
              ...
              silentCacheClient = this.createSilentCacheClient(
                request.correlationId
              );
              this.performanceClient.setPreQueueTime(
                exports.PerformanceEvents.InitializeSilentRequest,
            ...
            case 2:
              ...
              requestWithCLP_1 = __assign$1(__assign$1({}, request), {
                ...
                cacheLookupPolicy:
                  ...
                  exports.CacheLookupPolicy.Default,
              });
              this.performanceClient.setPreQueueTime(
                exports.PerformanceEvents.AcquireTokenFromCache,
                silentRequest_1.correlationId
              );
              result = this.acquireTokenFromCache(
                ...
                if (
                  requestWithCLP_1.cacheLookupPolicy ===
                ...
                BrowserUtils.blockReloadInHiddenIframes();
                _this.eventHandler.emitEvent(
                  exports.EventType.ACQUIRE_TOKEN_NETWORK_START,
                  exports.InteractionType.Silent,
                  silentRequest_1
                );
                _this.performanceClient.setPreQueueTime(
                  exports.PerformanceEvents.AcquireTokenByRefreshToken,
                  silentRequest_1.correlationId
                );
                return _this
                  .acquireTokenByRefreshToken(silentRequest_1, requestWithCLP_1)
                  .catch(function (refreshTokenError) {
                    var isServerError =
                      refreshTokenError instanceof ServerError;
                    var isInteractionRequiredError =
                      refreshTokenError instanceof InteractionRequiredAuthError;
                    var isInvalidGrantError =
              ...
              return [
                ...
                result
                  .then(function (response) {
                    ...
                    (_a = _this.astsAsyncMeasurement) === null || _a === void 0
                      ? void 0
                      : _a.endMeasurement({
                          success: true,
                          fromCache: response.fromCache,
  ...
  var EventMessageUtils = /** @class */ (function () {
     ...
     * @param currentStatus
     */
    EventMessageUtils.getInteractionStatusFromEvent = function (
      message,
      currentStatus
    ) {
  ...
  var SignedHttpRequest = /** @class */ (function () {
     ...
     */
    SignedHttpRequest.prototype.signRequest = function (
      payload,
      publicKeyThumbprint,
      claims
    ) {
      return __awaiter$1(this, void 0, void 0, function () {
        return __generator$1(this, function (_a) {
          return [
            2 /*return*/,
            this.popTokenGenerator.signPayload(
              payload,
              publicKeyThumbprint,
              this.shrParameters,
              claims
